<%@ Page Title="" Language="C#" MasterPageFile="~/MasterExterno.Master" AutoEventWireup="true" CodeBehind="ModificaContactoPaciente.aspx.cs" Inherits="Ext.Web.Paginas.ModificaContactoPaciente" %>
...
<div id="divwarning" class="alert alert-warning">
    ...
    <div id="divdanger" class="alert alert-danger">
        ...
        <div class="paciente"><label></label><span class="nombrePaciente"></span></div>
<table>
    <tr><td></td> </tr>
    <tr><td><div>
