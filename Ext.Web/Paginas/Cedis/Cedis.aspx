<%@ Page Title="" Language="C#" MasterPageFile="~/MasterExterno.Master" AutoEventWireup="true" CodeBehind="Cedis.aspx.cs" Inherits="Ext.Web.Paginas.Cedis.Cedis" %>
...
<div class="container">
 ...
 <tr>
            ...
            <td>
               <asp:TextBox ID="txtNombreCedis" runat="server"></asp:TextBox></td>
            <td>
                &nbsp;</td>
            <td>
                <label>clave Cedis:</label></td>
            <td>
                <asp:TextBox ID="txtClaveCedis" runat="server"></asp:TextBox></td>
        </tr>
       <tr>
            <td >
...
<div><asp:Button id="btnGuardar" runat="server" Text="Guardar" UseSubmitBehavior="false"
